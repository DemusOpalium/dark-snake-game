...
SOUNDS = {
    "eat": load_sound("eat.ogg"),
    "powerup": load_sound("powerup.ogg"),
    "boss": load_sound("boss.ogg"),
    "gameover": load_sound("gameover.ogg"),
    "dice": load_sound("dice.ogg"),
    "damage": load_sound("gameover.ogg"),
    "portalsound": load_sound("DarkSnakeMusicIndi2.ogg")
}
