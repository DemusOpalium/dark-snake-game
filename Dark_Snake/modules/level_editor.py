# modules/level_editor.py – FINAL UI-STRUKTUR
# ✔ Favoritenzeile oben
# ✔ Containertrennung: Buttons, Favoriten, Tiles, Karte
# ✔ Kein Überlappen mehr
# ✔ Maus-Zeichnen
# ✔ Debugausgaben für alle UI-Aktionen
...
FAV_ROW_H = 50
TILE_ROW_H = 250
MAP_TOP   = FAV_ROW_H + TILE_ROW_H - 40  # ⬅ Spielfeld höher angesetzt, Abstand nach unten entsteht
MAX_FAV   = 8
...
class LevelEditor:
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if mx < TOOLBAR_W and my < FAV_ROW_H + TILE_ROW_H:
    ...
    def draw(self, screen):
        ...
        for i, key in enumerate(keys):
            ...
            y = FAV_ROW_H + TILE_ROW_H + 10 + row * (GRID_SIZE + 4)
            img = self.tiles[key]
            screen.blit(img, (x, y))
            if key == self.current_tile:
                pygame.draw.rect(screen, COLOR_SELECT, (x, y, GRID_SIZE, GRID_SIZE), 2)
